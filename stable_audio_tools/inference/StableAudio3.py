...
import stable_audio_tools.models.conditioners as _conditioners
import transformers

_original_t5gemma_init = _conditioners.T5GemmaConditioner.__init__

def _patched_t5gemma_init(self, *args, **kwargs):
    """
    ...
    # also check subfolder — if present, removing it
    if "subfolder" in kwargs:
        del kwargs["subfolder"]
    
    return _original_t5gemma_init(self, *args, **kwargs)

_conditioners.T5GemmaConditioner.__init__ = _patched_t5gemma_init
